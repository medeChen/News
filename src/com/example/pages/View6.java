...
public class View6 extends LazyFragment  {
	List<News> ne;
	@Override
...
//				params, new RequestCallBack<String>() {
		...
		http.send(HttpRequest.HttpMethod.GET,
				"http://10.158.56.89:8080/axis2/services/MyService/getNewslist6",
				 new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						json = json.replace("<ns:getNewslist6Response xmlns:ns=\"http://aishang.ypf.com\"><ns:return>", "");
						json = json.replace("</ns:return></ns:getNewslist6Response>", "");
						...
						NewsAdapter<News> adapter = new NewsAdapter<News>(View6.this.getActivity(), listNews, R.layout.news1);
						listView.setAdapter(adapter);
						listView.setOnItemClickListener(new OnItemClickListener() {
							@Override
							public void onItemClick(AdapterView<?> parent,View view,int position,long id){
								Intent intent = new Intent(View6.this.getActivity(), Web.class);
