...
public class View2 extends LazyFragment  {
	List<News> ne;
	@Override
...
//				params, new RequestCallBack<String>() {
		...
		http.send(HttpRequest.HttpMethod.GET,
				"http://10.158.56.89:8080/axis2/services/MyService/getNewslist2",
				 new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						json = json.replace("<ns:getNewslist2Response xmlns:ns=\"http://aishang.ypf.com\"><ns:return>", "");
						json = json.replace("</ns:return></ns:getNewslist2Response>", "");
						...
						NewsAdapter<News> adapter = new NewsAdapter<News>(View2.this.getActivity(), listNews, R.layout.news1);
						listView.setAdapter(adapter);
						listView.setOnItemClickListener(new OnItemClickListener() {
							@Override
							public void onItemClick(AdapterView<?> parent,View view,int position,long id){
								Intent intent = new Intent(View2.this.getActivity(), Web.class);
